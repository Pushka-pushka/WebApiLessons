...
namespace HotelsWebApi.APIs
{
    public class HotelApi : IApi
    {
        public void Register(WebApplication app)
        {
            ...
            app.MapGet("/hotels/search/location/{coordinate}", SearchByCordinates)
                    .ExcludeFromDescription();
        ...
        [Authorize]
        private async Task<IResult> SearchByCordinates(Coordinate coordinate, IHotelRepository repository)=>
